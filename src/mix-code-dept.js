...
exports.departements = exports.originalDepartements = void 0;
const fs_1 = __importDefault(require("fs"));
const path_1 = __importDefault(require("path"));
exports.originalDepartements = [
...
exports.departements = exports.originalDepartements.map(d => {
    var _a;
    return (Object.assign(Object.assign({}, d), { code: (_a = String(codeParSlug[d.slug])) !== null && _a !== void 0 ? _a : null }));
});
const output = `// AUTO-GENERATED FILE\nexport const departements = ${JSON.stringify(exports.departements, null, 2)};\n`;
const outPath = path_1.default.resolve(__dirname, "../data/mixedDepts.ts");
